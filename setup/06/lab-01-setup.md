...
1. Provide the required values to create your Azure Databricks workspace:
   ...
   - **Resource Group**: Select `Create new` and provide the name `techionista-dp203-m6` for the new resource group.
...
1. Select the **Databricks Runtime Version**. We recommend the latest runtime and **Scala 2.12**.
